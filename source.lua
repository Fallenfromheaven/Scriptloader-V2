...
local gamePlaceIDs = {
    ...
    ["Blade Ball"]       = {13772394625,14732610803,15131065025,15234596844,16331600459,15144787112,15264892126,16581637217}
}
...
queue_on_teleport("local Rayfield = loadstring(game:HttpGet('https://sirius.menu/rayfield'))()Rayfield:Destroy()task.wait(20)loadstring(game:HttpGet('https://raw.githubusercontent.com/Fallenfromheaven/Scriptloader-V2/refs/heads/main/loader.lua'))()")
