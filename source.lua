...
if game_name == "Da Hood" then

    local game13 = Window:CreateTab("Da Hood", 4483362458)

    local g13_Section_1 = game13:CreateSection("Stand Script")
    local g13_Input_1 = game13:CreateInput({
        Name = "Stand Owner",
        CurrentValue = "",
        ...
        Callback = function(Text)
            getgenv().owner = Rayfield.Flags["g13_input_1"].CurrentValue
        end,
    })
    local g13_Button_1 = game13:CreateButton({
        Name = "Stand Script",
        Callback = function()
            getgenv()._="Join discord.gg/msgabv2t9Q | discord.gg/stando to get latest update ok bai aaa| If you pay for this script you get scammed, this script is completely free ok"
